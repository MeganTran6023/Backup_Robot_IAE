...
print('''
========================================
 Turn Control (Hold BOTH keys)
========================================
 Hold Shift + Left  : Turn Left
 Hold Shift + Right : Turn Right
...
try:
    while True:
        ...
        # =======================
        if key == '\x1b[1;2D':
            board.set_motor_duty([[1, MOTOR_SPEED], [3, MOTOR_SPEED]])
            last_turn_time = now
            continue
        ...
        # =======================
        if key == '\x1b[1;2C':
            board.set_motor_duty([[2, -MOTOR_SPEED], [4, -MOTOR_SPEED]])
            last_turn_time = now
            continue
