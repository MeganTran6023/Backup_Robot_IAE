"""
Combined Motor, Servo, and Ultrasonic Control
---------------------------------------------
- Wheels continuously move forward/backward in a loop.
- Ultrasonic sensor measures distance.
- Servos move randomly.
...
def wheel_loop():
    """Continuously move wheels forward/backward"""
    try:
        while True:
...
if __name__ == "__main__":
    try:
        print("🎯 Starting All Systems (Motors + Servos + Ultrasonic)")
